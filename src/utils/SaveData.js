...
function sanitizeFoe(raw) {
  ...
  return {
    ...
    bannerLabel: typeof raw.bannerLabel === "string" ? raw.bannerLabel : "",
    cosmeticSubtitle: typeof raw.cosmeticSubtitle === "string" ? raw.cosmeticSubtitle : "",
    systemNotice: typeof raw.systemNotice === "string" ? raw.systemNotice : "",
